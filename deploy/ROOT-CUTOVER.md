...
Docker frontend publishes on host port **`${FRONTEND_HOST_PORT:-3000}`** (local default **3000**). On production set `FRONTEND_HOST_PORT=3000` in the root `.env` so nginx can use:
