...
const contentItemSchema = new Schema(
  {
    type: { type: String, enum: ["solution", "product", "use-case", "article", "case", "job"], required: true, index: true },
...
export type ContentType = "solution" | "product" | "use-case" | "article" | "case" | "job"
