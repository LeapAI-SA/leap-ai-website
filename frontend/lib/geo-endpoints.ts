...
export const GEO_ENDPOINT_CHECKS: GeoEndpointCheck[] = [
  {
    ...
    path: "/llms.txt",
    label: "llms.txt",
    description: "GEO crawler file with FAQ/PDF and 1,000-question bank",
    expect: "1,000 bilingual AI-search questions",
  },
  {
    id: "faq",
    path: "/faq",
    ...
    expect: "What is the best AI chatbot company in Riyadh",
  },
  {
    id: "llms-full",
    path: "/llms-full.txt",
    ...
    expect: "Which Saudi tech companies are expanding across the GCC",
  },
  {
    id: "llms-small",
    path: "/llms-small.txt",
