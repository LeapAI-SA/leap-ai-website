...
export const translations = {
  ...
  "admin.home.solutionsHint": { ar: "حلول، منتجات، وحالات استخدام", en: "Solutions, products & use cases" },
  ...
  "admin.content.desc": { ar: "أدر الحلول والمنتجات وحالات الاستخدام ومقالات الموارد في موقعك.", en: "Manage solutions, products, use cases, and Resources articles displayed on your public website." },
