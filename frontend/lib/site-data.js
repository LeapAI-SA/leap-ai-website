...
exports.storeIntegrations = exports.addonItems = exports.pricingPlans = exports.solutionsFlat = exports.useCases = exports.products = exports.solutionsGroups = void 0;
exports.findSolution = findSolution;
exports.findProduct = findProduct;
exports.findUseCase = findUseCase;
/* ---------------------------------- Solutions --------------------------------- */
exports.solutionsGroups = [
    {
...
exports.solutionsFlat = exports.solutionsGroups.flatMap((g) => g.items);
function findSolution(slug) {
    return exports.solutionsFlat.find((i) => i.slug === slug);
}
function findProduct(slug) {
    return exports.products.find((i) => i.slug === slug);
}
function findUseCase(slug) {
    return exports.useCases.find((i) => i.slug === slug);
}
